...
from app.config import AppConfig, get_session, init_db
...
def create_app(config: AppConfig = AppConfig()) -> Flask:
    ...
    @app.post("/api/project/<int:project_id>/station")
    ...
    @app.get("/api/simulation/<string:simulation_id>/status")
    ...
    def analytics_population():
        ...
        with get_session() as session:
            ...
            stmt = (
                select(population_sum, household_sum)
